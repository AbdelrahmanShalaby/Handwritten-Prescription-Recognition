...
def ReadData(filesLocation, filesList, numberOfFiles, WND_HEIGHT, WND_WIDTH, WND_SHIFT, VEC_PER_WND, transDir=''):
    ...
    inputList = []
    targetList = []
    Files = filesLocation.split('/')
    Cur = Files[4]
    # if (os.path.exists('Training.npy') and Cur=="Training"):
    #     inputList = np.load('Training.npy')
    #     seqLens = np.load('SeqTraining.npy')
    #     targetList = np.load('TargetList.npy')
    #     return inputList, seqLens, targetList
    # elif (os.path.exists('Testing.npy') and Cur=="Testing"):
    #     inputList = np.load('Testing.npy')
    #     seqLens = np.load('SeqTest.npy')
    #     return inputList, seqLens, targetList
    # else:
    ...
    #
    # if Cur=="Testing":
    #     np.save('Testing.npy', inputList)
    #     np.save('SeqTest.npy', seqLens)
    # else:
    #     np.save('Training.npy', inputList)
    #     np.save('SeqTraining.npy', seqLens)
