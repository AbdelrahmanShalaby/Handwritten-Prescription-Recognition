...
flags.DEFINE_string('ImageFileType', '.jpg', 'The file type of images')
flags.DEFINE_string('LabelFileType', '.tru', 'The extension of the file holding the ground-truth labels')

######################################
#Training data configuration
flags.DEFINE_integer('TRAIN_NB', 10, 'Number of training images to process')
flags.DEFINE_string('TRAIN_LIST', './samples/Training_List', 'List of training data without file extension.')
flags.DEFINE_string('TRAIN_LOCATION', './samples/Images/000033/Training', 'Location of training data. Could be included in the data list.')
flags.DEFINE_string('TRAIN_TRANS', './samples/Labels/000033/Training_Labels', 'Location of training data transcriptions')

######################################
#Validation data configuration
flags.DEFINE_integer('VAL_NB', 10, 'Number of validation images to process')
flags.DEFINE_string('VAL_LIST', './samples/Training_List',	'List of validation data without file extension.')
flags.DEFINE_string('VAL_LOCATION', './samples/Images/000033/Training', 'Location of validation data. Could be included in the data list.')
flags.DEFINE_string('VAL_TRANS', './samples/Labels/000033/Training_Labels', 'Location of validation data transcriptions')

######################################
#Test data configuration
flags.DEFINE_integer('TEST_NB',3, 'Number of test images to process')
flags.DEFINE_string('TEST_LIST', './samples/Testing_List', 'List of test data without file extension.')
flags.DEFINE_string('TEST_LOCATION', './samples/Images/000033/Testing', 'Location of test data. Could be included in the data list.')
...
flags.DEFINE_string('LogFile', './log.txt', 'Log file')
...
flags.DEFINE_integer('NEpochs', 1, 'Run the training for n epochs')
